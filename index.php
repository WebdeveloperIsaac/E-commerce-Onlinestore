	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				...
				<a href="index.php" class="navbar-brand">Isaac's Ecommerce Site</a>
			</div>
					...
					<ul class="dropdown-menu">
						<div style="width:300px;">
							<div class="panel panel-primary">
								...
								<div class="panel-footer" id="e_msg">Login to Isaac's E-commerce store</div>
							</div>
						</div>
					</ul>
				</li>
		...
		<div class="row">
			...
			<div class="col-md-8 col-xs-12">
				...
				<div class="panel panel-info">
					...
					<div class="panel-footer">&copy; <?php echo date("Y"); ?> Isaac Sotware Solutions</div>
				</div>
			</div>
			<div class="col-md-1"></div>
		</div>
